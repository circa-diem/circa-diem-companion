...
module CircaDiem
  ...
  class ExtraField::UniversalTime < ExtraField::Generic # :nodoc:
    ...
    def merge(binstr)
      ...
      @mtime ||= CircaDiem::Zip::DOSTime.at(times.shift) unless @flag & MTIME_MASK == 0
      return if times[0].nil?

      @atime ||= CircaDiem::Zip::DOSTime.at(times.shift) unless @flag & ATIME_MASK == 0
      return if times[0].nil?

      @ctime ||= CircaDiem::Zip::DOSTime.at(times.shift) unless @flag & CTIME_MASK == 0
    end
