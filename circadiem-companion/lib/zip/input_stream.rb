...
module CircaDiem
  ...
  #
  #   CircaDiem::Zip::OutputStream.open("my.zip") do |io|
  #
  ...
  #
  #
  #   CircaDiem::Zip::InputStream.open("my.zip") do |io|
  #
  ...
  class InputStream
    ...
    def initialize(context, offset: 0, decrypter: nil)
      ...
      @decompressor = CircaDiem::Zip::NullDecompressor
      @decrypter = decrypter || CircaDiem::Zip::NullDecrypter.new
      @current_entry = nil
      @complete_entry = nil
    end
    ...
    class << self
      ...
      def open_buffer(filename_or_io, offset: 0)
        ...
        CircaDiem::Zip::InputStream.open(filename_or_io, offset: offset)
      end
    end
    ...
    def open_entry
      @current_entry = CircaDiem::Zip::Entry.read_local_entry(@archive_io)
      return if @current_entry.nil?
    ...
    def get_decrypted_io
      ...
      CircaDiem::Zip::DecryptedIo.new(@archive_io, @decrypter)
    end

    def get_decompressor
      return CircaDiem::Zip::NullDecompressor if @current_entry.nil?
      ...
      decompressor_class = CircaDiem::Zip::Decompressor.find_by_compression_method(
        @current_entry.compression_method
      )
      if decompressor_class.nil?
        raise CircaDiem::Zip::CompressionMethodError, @current_entry.compression_method
      end
