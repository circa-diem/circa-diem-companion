...
Sketchup::require 'circadiem-companion/lib/zip/filesystem/file_stat'

module CircaDiem
  module Zip
  module FileSystem
    # Instances of this class are normally accessed via the accessor
    # CircaDiem::Zip::File::file. An instance of File behaves like ruby's
    # builtin File (class) object, except it works on CircaDiem::Zip::File entries.
    #
